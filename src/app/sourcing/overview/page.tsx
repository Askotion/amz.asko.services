  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (info: Cell<Purchase, unknown>) => {
        ...
        const amazonProductUrl = `https://www.amazon.de/dp/${asin}`;
        ...
        return (
          <a 
            ...
            className="block h-20 w-20 bg-white border border-gray-200 shadow-sm rounded flex items-center justify-center mx-auto overflow-hidden hover:border-blue-300 hover:shadow-md transition-all"
          >
            <img 
              src={amazonImageUrl} 
              alt={`Product ${asin}`}
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).parentElement!.className = "block h-20 w-20 bg-white border border-gray-200 shadow-sm rounded flex items-center justify-center mx-auto hover:border-blue-300 hover:shadow-md transition-all";
  ...
  return (
    <section aria-label="Purchases">
      ...
      <div className="relative mb-20">
        ...
        <div
          className={cx(
            'fixed bottom-6 left-1/2 transform -translate-x-1/2 z-10 flex items-center rounded-tremor-default shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800',
            Object.keys(rowSelection).length > 0 ? '' : 'hidden',
          )}
        >
          <div className="flex items-center gap-1 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 border-r border-gray-200 dark:border-gray-800">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-500">
          ...
          <div className="flex divide-x divide-gray-200 dark:divide-gray-800">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors"
            >
              <ShoppingBag className="size-4 text-gray-500 dark:text-gray-400" />
              Capture purchase
            </button>
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors"
            >
              <Trash className="size-4 text-gray-500 dark:text-gray-400" />
              Delete selected
            </button>
          </div>
        </div>
